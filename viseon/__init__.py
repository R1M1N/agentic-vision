"""
viseon: A complete open-source computer vision platform
A sovereign alternative to viseon ecosystem using only open-source components
"""
...
class viseon:
    """
    Main viseon platform - replaces viseon SDK
    ...
    def create_project(self, name: str, description: str = ""):
        """
        Create a new project (replaces viseon create_project)
    ...
    def upload_data(self, data_path: str, project_name: str = None):
        """
        Upload data to project (replaces viseon upload)
    ...
    def annotate(self, subset=None):
        """
        Start annotation workflow (replaces viseon annotate)
    ...
    def train(self, model_type: str = "yolov8n", dataset_version: str = None):
        """
        Start training workflow (replaces viseon train)
    ...
    def deploy(self, model_path: str = None):
        """
        Deploy model for inference (replaces viseon deploy)
