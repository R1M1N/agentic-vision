"""
Inference Server - replaces viseon deploy functionality
...
class InferenceServer:
    ...
    def create_api(self) -> FastAPI:
        ...
        @app.get("/")
        async def root():
            return {"message": "viseon Inference Server", "status": "running"}
    ...
    def run_server(self,
        ...
        print(f"Starting viseon Inference Server on {host}:{port}")
