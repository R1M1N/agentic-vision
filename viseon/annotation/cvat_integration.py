"""
CVAT Integration - replaces viseon annotate functionality
...
class CVATAnnotate:
    ...
    def send_samples_to_annotation(self,
        ...
        """
        Send samples to CVAT for annotation (replaces viseon annotate)
        ...
        return self.create_annotation_task(
            ...
            images=samples,
            labels=labels,
            description="viseon annotation task"
        )
