"""
YOLO Training System - replaces roboflow-python train functionality
...
class YOLOTrainer:
    ...
    def _setup_mlflow(self):
        ...
        # Set experiment
        experiment_name = self.mlflow_config.get('experiment_name', 'opensupervision_training')
    ...
    def start_training(self,
                      ...
                      augment: bool = True,
                      save_period: int = 10,
                      project_name: str = "opensupervision_training",
                      experiment_name: str = None,
                      resume: bool = False,
                      pretrained: bool = True) -> Dict:
        """
        Start YOLO training (replaces roboflow-python train)
    ...
    def get_training_history(self) -> List[Dict]:
        ...
        try:
            experiment = mlflow.get_experiment_by_name(
                self.mlflow_config.get('experiment_name', 'opensupervision_training')
            )
